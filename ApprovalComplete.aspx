<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApprovalComplete.aspx.cs" Inherits="Currey_HW7.ApprovalComplete" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Approval Complete!</title>
    <meta charset="utf-8"/>
        ...
        <div class="jumbotron center-block" align="center">
            ...
            <div class="row center-block">
                <div class="col-sm-12 center-block">
                    <h5>Each student has been notified via email of your approval, and their student profiles have been updated to reflect your decision.</h5>
                    <br />
